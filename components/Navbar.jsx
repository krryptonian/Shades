...
const Navbar = () => {
  ...
  return (
    <div className='flex flex-col'>
      ...
      <AnimatePresence>
        {SearchBoxIsOpen && (
          <motion.div animate={{ height: 'auto' }} initial={{ height: 0 }} exit={{ height: 0 }} className='bg-gray-800'>
            <div className='container'>
              <input
                type='search'
                autoComplete='off'
                className='appearance-none w-full py-3 bg-gray-800 text-gray-50 focus:outline-none transition duration-150 ease-in-out'
